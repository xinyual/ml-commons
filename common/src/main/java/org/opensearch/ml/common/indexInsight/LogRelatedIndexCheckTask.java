...
public class LogRelatedIndexCheckTask extends AbstractIndexInsightTask {
    ...
    public LogRelatedIndexCheckTask(String sourceIndex, Client client, SdkClient sdkClient, String cmkRoleArn) {
        super(MLIndexInsightType.LOG_RELATED_INDEX_CHECK, sourceIndex, client, sdkClient, cmkRoleArn);
    }
